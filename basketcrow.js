...
function tick() {
    ...
    if(scene==0) {
        ...
        //draw p1 n p2
        ctx.drawImage(img_p1, 100,100,40,36);
        ctx.drawImage(img_p2,500,100,40,36);
        //draw team names
        ctx.drawImage(img_team_chicago_ui,100,20,110,110);
        ctx.drawImage(img_team_sfo_ui,500,20,110,110);      
